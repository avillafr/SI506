...
Specific Directions:
A person should locate the directory of my file SI506SI506F18_final_project.py after downloading it. They should run it using Python 3. They should type python3 SI506F18_final_project.py in the command prompt and hit enter.
...
Cache all data: 5-25, 33-45, 57-69
Retrieve data from 2 different API endpoints: 28-32, 52-56
Include at least 2 function definitions: 28-33, 52-57
Include at least 2 class definitions: 76-115, 122-158
Create at least 1 instance of each class and invoke methods on them: 79 & 117, 125 & 160
Accumulate data: 165-170, 173-179
Write data to a file: 182-188
